...
class Stack:
    ...
    def push(self, data):
        ...
        """Asetetaan uusi node pinon päälle"""
        self._top = new_node
        self._size += 1
    ...
    def pop(self):
        ...
        """Linkataan päällimmäinen edelliseen"""
    ...
    def __repr__(self):
        ...
        if self._size >1 or self._size <1:
            return f'<Stack ({self._size} elements): [{values.lstrip(", ")}]>'
        else:
            return f'<Stack ({self._size} element): [{values.lstrip(", ")}]>'
